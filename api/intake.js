...
module.exports = async function handler(req, res) {
  ...
  const { sessionId, name, email, phone, age, location, birthDate, birthTime, birthPlace, focus, manifestation, duration, childhood, outcome, previous, medical, hypno, extra, consentSignature, consentDate } = req.body;
