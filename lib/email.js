...
async function sendSessionConfirmation(to, { name, focus, manifestation, duration, childhood, outcome, previous, medical, hypno, extra, consentSignature, consentDate }) {
  ...
  const body = `
    ...
    ${sectionHeading('Prepare for your session')}
    ${p('This is your dedicated time for deep, empowering shifts and harmonious nervous system regulation.')}
    ${p('To create a beautifully seamless and comfortable experience, please prepare for our session by completing these steps before we connect:')}
    ...
    ${sectionHeading('A gift to prepare your mind')}
    ${p(`To help your mind drop into hypnosis more quickly and deeply during our live session, I want to invite you to start listening to my <strong>Nervous System Regulation</strong> hypnosis audio — available as a free gift when you join my email list.`)}
    ${p(`Listen with headphones <strong>every morning as you wake up</strong> and <strong>every night as you fall asleep</strong>. This conditions your subconscious to enter a deep, receptive state with ease — so when we work together live, you'll go even deeper, faster.`)}
    <div style="margin:4px 0 28px;">
      ${ctaButton('Get the Free Audio →', FREEBIE_URL)}
    </div>
