...
const PRODUCTS = {
  ...
  // ── SAFE TO BE SEEN — $297 COURSE BUNDLE ─────────────────────────────────
  // Course + shadow work journal + 3 hypnosis audios + IG strategy guide.
  // Sold on /safetobeseen. Files below are the deliverables that exist today;
  // TODO before launch:
  //   1. Create a $297 Stripe price and replace the placeholder ID below.
  //   2. Upload the Shadow Work Self-Inquiry Journal PDF to Drive and add it here.
  //   3. Add the course-hub access link/file once modules are recorded.
  safe_to_be_seen: {
    id: 'safe_to_be_seen',
    name: 'Safe to Be Seen — Course + Full Bundle',
    stripePriceId: 'price_REPLACE_WITH_297_PRICE_ID', // TODO: create $297 price in Stripe
    isCourse: true,
    files: [
      { name: 'How to Master the Game of Instagram.pdf', driveFileId: '1p1c6itLaYe0jrpiZ0LuuDbXhGite-dbT' },
      { name: 'Nervous System Regulation.mp3', driveFileId: '1AdAelwPHluh8RP18TcCdN4AH9lGwGm_T' },
      { name: 'Unwavering Self-Confidence.mp3', driveFileId: '1EaVtT0g-9Koag81xUgbHvkojraBCE218' },
      { name: 'Instagram Identity Shift.mp3', driveFileId: '1JNlZhCFS42QeD5Dqtz2wl9Ot0puV-48Q' },
    ],
  },
