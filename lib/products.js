...
const PRODUCTS = {
  ...
  instagram_guide: {
    id: 'instagram_guide',
    name: 'How to Win the Game of Instagram',
    stripePriceId: 'price_1TkiJmC38S5O6HWPNZHuHzJC', // $37
    files: [{ name: 'How to Win the Game of Instagram.pdf', driveFileId: '1p1c6itLaYe0jrpiZ0LuuDbXhGite-dbT' }],
  },
  instagram_guide_bundle: {
    id: 'instagram_guide_bundle',
    name: 'How to Win the Game of Instagram + Instagram Identity Shift Audio Bundle',
    stripePriceId: 'price_1TkiK7C38S5O6HWPG2fLMCD6', // $60
    files: [
      { name: 'How to Win the Game of Instagram.pdf', driveFileId: '1p1c6itLaYe0jrpiZ0LuuDbXhGite-dbT' },
  ...
  instagram_guide_audit: {
    ...
    name: 'How to Win the Game of Instagram + 1:1 Audit',
    stripePriceId: 'price_1TkiLEC38S5O6HWPPrN7NNwO', // $387
  ...
  instagram_guide_audio_audit: {
    ...
    name: 'How to Win the Game of Instagram + Audio + 1:1 Audit (Full Bundle)',
    stripePriceId: 'price_1TkiLbC38S5O6HWP9xSxNM7X', // $395
    isSession: true,
    files: [
      { name: 'How to Win the Game of Instagram.pdf', driveFileId: '1p1c6itLaYe0jrpiZ0LuuDbXhGite-dbT' },
      { name: 'Instagram Identity Shift.mp3', driveFileId: '1JNlZhCFS42QeD5Dqtz2wl9Ot0puV-48Q' },
  ...
  instagram_audit_session: {
    id: 'instagram_audit_session',
    name: '1:1 Instagram Audit & Strategy Session',
    stripePriceId: 'price_1TkiMLC38S5O6HWPzjaUjeId', // $350
    isSession: true,
    files: [],
  },
};
